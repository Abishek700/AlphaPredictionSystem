...
analysing the gait pattern also gives us information about the persons previous accidents or even about current neuronal problem as changes of gait patterns could in fact be a symptom of some sicknesses like Parkinson.

the long term goal of this project would be to enable individuales analyse their own gait pattern and recognise if there is something wrong with them at a reasonable price Tag. 
