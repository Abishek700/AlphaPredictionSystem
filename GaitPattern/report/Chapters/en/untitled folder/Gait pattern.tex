...
Additionally, the accelerometer present on our board can also help detect and classify walking, running, and jumping. Based on the acceleration of the body segment, the algorithm can distinguish the type of motion.
