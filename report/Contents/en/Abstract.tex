...
\addcontentsline{toc}{chapter}{Abstract}
	...
	The machine learning model was evaluated using previously unseen data and achieved a mean absolute prediction error of approximately 0.014, which is small relative to the typical range of $\alpha$ values between 0.001 and 0.15. The complete system was then tested on 20 real studies that had originally been reported as significant using $\alpha = 0.05$ but later failed to replicate. In 13 of these cases, the system would have recommended a stricter threshold, meaning that the original results might not have been declared significant.
