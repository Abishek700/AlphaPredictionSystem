...
Power represents the probability of correctly rejecting the null hypothesis when it is false. It depends on several factors, including the sample size, the true effect size, and the chosen significance level. Cohen (1988) later emphasized the importance of power analysis in study design \cite{Cohen1988}.
...
To summarize these conceptual differences, \ref{TablefisherNP} presents a direct comparison of the two approaches.
