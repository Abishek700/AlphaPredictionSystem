...
Statistical power can be expressed as
...
Equation~\ref{eq:power_definition} highlights the direct relationship between statistical power and the probability of a Type II error. Power is influenced by three main factors: the significance level $\alpha$, the sample size $N$, and the true effect size. Cohen (1988) emphasized that these elements should be considered jointly during study planning \cite{Cohen1988}.
...
From this perspective, some researchers argue that $\alpha$ should be chosen in conjunction with sample size planning. Although this approach improves study design, it typically still relies on selecting $\alpha$ from a small set of conventional values.
